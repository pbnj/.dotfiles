return {
  {
    ...
    keys = {
      ...
      { "gs", function() Snacks.picker.lsp_symbols() end, desc = "[G]oto Buffer [S]ymbols", },
      { "gS", function() Snacks.picker.lsp_workspace_symbols() end, desc = "[G]oto Workspace [S]ymbols", },
      { "gy", function() Snacks.picker.lsp_type_definitions() end, desc = "[G]oto T[y]pe Definition", },
      { "<leader>ss", function() Snacks.picker.lsp_symbols() end, desc = "[S]earch Global [S]ymbols", },
      { "<leader>sS", function() Snacks.picker.lsp_workspace_symbols() end, desc = "[S]earch Global [S]ymbols", },
      -- utilities
